...
SECRET_KEY = 'django-insecure-hsm2%h6or4yj3ahp(5@grw=azyy-^i@$l($a*@$*uf!=5^250t'
...
INSTALLED_APPS = [
    'tubercontacts.apps.TubercontactsConfig',
    'weblink.apps.WeblinkConfig',
